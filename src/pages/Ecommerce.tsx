  ...
  return (
    <div className="mt-12 ">
      <div className="flex flex-wrap lg:flex-nowrap justify-center ">
        <div
          className="bg-white dark:text-grey-200 dark:bg-secondary-dark-bg h-44 
        ...
        >
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-black text-2xl dark:text-white">₦63,448.78</p>
            </div>
          </div>
          <div className="mt-6 ">
            <Button
              ...
              <p className="mt-3">
                ...
                <span
                  className={`text-sm ml-2 ${
                    item.pcColor === "-" ? "text-red-600" : "text-green-600"
                  }`}
                >
                  {item.percentage}
                </span>
        ...
        >
          ...
          <div className="mt-10 flex gap-10 flex-wrap justify-center">
            <div className="border-r-1 border-color m-4 pr-10">
              ...
              <div className="mt-8">
                <p>
                  <span className="text-3xl font-semibold">₦58,444</span>
                </p>
