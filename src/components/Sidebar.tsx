...
const Sidebar = () => {
  ...
  // Conditional Styling for NavLinks
  const ActiveLink =
  ...
  return (
    <div
      className="ml-3 h-screen md:overflow-hidden overflow-auto z-[10000000]
          ...
          <div className="flex justify-between items-center">
            ...
            <TooltipComponent content="Close" position="BottomCenter">
              <button
                ...
                className="text-xl rounded-full hover:bg-light-gray p-3 mt-4 
                block md:hidden"
              >
                <MdOutlineCancel />
              </button>
